<?php
/**
 * Compliment_Box Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_compliment_box_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/compliment-box.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_compliment_box_plugin' );
