    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                ...
                files: { 'assets/css/compliment-box.css': 'assets/css/sass/styles.scss' }
            }
        },
        cssmin: { dist: { files: { 'assets/css/compliment-box.min.css': 'assets/css/compliment-box.css' } } },
        usebanner: {
            taskName: {
                options: {
                    position: 'top',
                ...
                files: { src: ['assets/css/compliment-box.min.css'] }
            }
        }
    });
